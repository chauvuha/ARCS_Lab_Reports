...
| 06/08 | Tried training our 2ndRunHighRes dataset with the 4 chosen CNN models from the research paper and compared their accuracies. Tried different data angmentation techniques with the datasets.
...
| 06/11 | Started trying to rebuild models from the research paper, starting with BasicClassification.py
...
* Following FastAi documentation and tutorials, I created the confusion matrix and cleaner to clean my data and improve models' performance. After that, I deployed the model using Gradio + HuggingFace. Here is the link to the live model: https://huggingface.co/spaces/chauhavu/ufo-model.
  ...
  <img width="800" alt="Screenshot 2023-06-12 at 1 19 13 AM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/2c49520c-d585-4c44-bbfb-eff843de0406">


  <img width="800" alt="Screenshot 2023-06-12 at 1 19 32 AM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/2d7eaa15-3eb7-4309-8a34-5f59a9b64489">


  <img width="800" alt="Screenshot 2023-06-12 at 1 20 18 AM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/25e17192-74d7-4947-9cc6-652fa6859854">
...
# 2. Experimenting with current UE dataset (most data augmentation methods)(data/clark/data/2ndRunHighRes, OldenborgSmall-2022-07-11, Oldenborg-2022-07-01, and Office127-2022-07-0): 
   ...
   * I also explored data augmentation methods that are supported in FastAI's vision learner:
      * RandomResizeCrop,
      * Resize
      * Aug_transform
 ...
 * I found that Resnet34 has the highest accuracy and deployed the this model to HuggingFace. Here is the link to the live model: https://huggingface.co/spaces/chauhavu/oldenborg-model.  I also included the sample test cases from the Oldenborg-2022-07-01 dataset. 
  <img width="700" alt="Screenshot 2023-06-12 at 9 35 23 AM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/3859dca6-9a54-4224-a960-df2290bc5575">

# 4. Rebuilding Command+Image (ongoing)
* I have several questions to investigate:
    * I started with the BasicClassification.py first. I explored the datasets and the pretrained models included in the file "uniform-full". I had a question about the difference between fit_one_cycle() and fine_tune(), as well as how we obtained the pre-trained models for this dataset.
    <img width="270" alt="Screenshot 2023-06-12 at 3 34 49 PM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/558fa0fe-ecdc-4bbc-9d98-96f8a62bfcf7">
    * I am already trying to replicate the stack, panel, and hybrid model. But for the custom models (paneled and stacked) that were created based on the 4 chosen CNN networks, how exactly can I stack or panel (integrate the previous action or input into the model architecture)? I plan to spend more time to understand the code and architecture of these models.     
...
* I ran into several problems with git and hugging face that are not covered in the tutorial, which I think mostly is because the tutorial just skipped the part where we had to modify the app.py file, and did not really tell where to put it. Here is the right steps to deploy.
    ...
    * Add a ```app.py``` file in the open directory in VSCode. Here is my full code in ```app.py``` for it to work:
      ...
      <img width="700" alt="Screenshot 2023-06-12 at 2 11 54 AM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/56298c4a-7b16-4064-b7a8-a1f16f699977">
    ...
    *  Add requirement.txt file in the open directory in VSCode. The file includes two lines: fastai and scikit-image. This file is to specify the dependencies required for the project to run when deployed
        <img width="493" alt="Screenshot 2023-06-12 at 1 56 58 AM" src="https://github.com/chauvuha/ARCS_Lab_Reports/assets/79251745/6783d158-3b1d-4d15-8226-4dfabbff3925">
...
# Research readings
* Continue recreating the models in the Investigating Neural Network Architectures, Techniques, and Datasets for Autonomous Navigation paper. 

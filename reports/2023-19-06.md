...
| 06/17 | Meeting with Daisy about experimenting with Sweet Home 3D. Created an Oldenborg model on Sweet Home 3D.
...
# 3. Others
* I followed the tutorial on how to create a game package in UE on MacOS. It took 20 minutes for the shaders to compile but worked at the end:

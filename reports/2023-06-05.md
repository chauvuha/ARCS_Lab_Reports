...
* Watched fastai tutorial #1: 
   * <u> What I learned </u>: I applied the lesson and built a simple "stairs" image classifier model at lesson-01.ipynb. The model is going to differentiate whether the picture shows stairs or just a wall. I created a Datablock, a learner, and learned how to train the model:
...
# Issues:
* Remember to install fastbook and duckduckgo_search with "!", because these two should be downloaded using a shell command. 

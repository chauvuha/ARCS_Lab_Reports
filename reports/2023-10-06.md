...
# 4. Recreating notebooks to train models (CNN Basic & Command+Image) in the research paper (ongoing)
   * I recreate BasicClassification.py first. My notes on the inner workings of the model:
       ...
       * Training accuracy of the model is high regardless of whether use_pretraining is true or false (>98%). I plan to investigate whether this is related to performance with the validation mazes.
  ...
  * I started exploring CmdClassification.py.

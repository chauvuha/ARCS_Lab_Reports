...
* I ran into several problems with git and hugging face that are not covered in the tutorial, which I think mostly is because the tutorial just skipped the part where we had to modify the app.py file. Here is the right steps to deploy.

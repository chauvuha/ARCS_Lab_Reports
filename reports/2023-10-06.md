...
| 06/08 | Trained our 2ndRunHighRes dataset with the 4 chosen CNN models from the research paper and compared their accuracies. Tried different data angmentation techniques thanks to the resources from Francisco's notes.

...
# 4. Rebuilding models (CNN Basic & Command+Image) (ongoing)
   * I started with the BasicClassification.py. I explored the datasets and the pretrained models included in the file "uniform-full". This is my notebook after rebuilding the basic CNN model and training with resnet18:
